...
@section('title', 'Riwayat Reservasi - Perawat')

@section('page-title', 'Riwayat Reservasi')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('perawat.dashboard') }}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{ route('perawat.antrian.index') }}">Antrian</a></li>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card card-success card-outline">
                ...
                <div class="card-body">
                    <form action="{{ route('perawat.antrian.history') }}" method="GET" class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 d-flex align-items-end">
                            <div class="form-group mb-0">
                                ...
                                <a href="{{ route('perawat.antrian.history') }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card card-success card-outline">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-history mr-2"></i>Riwayat Semua Reservasi
                    </h3>
                    <div class="card-tools">
                        <a href="{{ route('perawat.antrian.index') }}" class="btn btn-sm btn-outline-success">
                    ...
                    <table id="historyTable" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong><i class="fas fa-paw text-success mr-1"></i>{{ $item->pet->nama ?? '-' }}</strong>
                                    <br>
                                ...
                                <td>
                                    @if($item->rekamMedis)
                                        <a href="{{ route('perawat.rekammedis.show', $item->rekamMedis->idrekam_medis) }}" 
                                           class="btn btn-info btn-sm" title="Lihat Rekam Medis">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('perawat.rekammedis.edit', $item->rekamMedis->idrekam_medis) }}" 
                                           class="btn btn-warning btn-sm" title="Edit Rekam Medis">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    @else
                                        <a href="{{ route('perawat.rekammedis.create', $item->idreservasi_dokter) }}" 
                                           class="btn btn-success btn-sm" title="Buat Rekam Medis">
                                            <i class="fas fa-plus"></i> Buat RM
                                        </a>
                                    @endif
                                </td>
                            </tr>
