...
<div class="min-h-screen bg-gradient-to-tr from-blue-100 via-pink-50 to-pink-100 text-gray-800 font-poppins">
  ...
  <nav class="navbar navbar-expand-lg py-3 shadow-sm"
      ...
      <div class="container">
          <a class="navbar-brand fw-bold text-white">⚙️ Dashboard Admin</a>
  ...
  <section class="text-center py-5">
      <div class="container">
          ...
          <p class="text-muted fs-5">Kelola data hewan, pemilik, dan layanan klinis di sistem RSHP.</p>
      </div>
  </section>
  ...
  <div class="text-center py-4">
      <a href="{{ route('admin.datamaster') }}"
         class="btn btn-lg fw-bold text-white px-5 py-3 rounded-pill shadow-sm"
         style="background: linear-gradient(to right, #2563eb, #7c3aed, #ec4899); border: none;">
