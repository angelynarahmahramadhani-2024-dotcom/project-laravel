...
<div class="min-h-screen bg-gradient-to-tr from-blue-100 via-pink-50 to-pink-100 text-gray-800 font-poppins">
  ...
  <!-- 🔝 Topbar -->
  <nav class="d-flex justify-content-between align-items-center px-4 py-3 shadow-sm" style="background-color: #6a5cf6;">
    <a href="{{ route('admin.dashboard') }}" class="text-white fw-semibold text-decoration-none">
      ← Kembali ke Dashboard
    </a>
    <h5 class="text-white fw-bold mb-0"><i class="bi bi-gear-fill me-1"></i> Data Master</h5>
  </nav>
      ...
      <div class="row g-4 justify-content-center">
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.jenishewan.index') }}" class="btn btn-outline-primary rounded-pill px-4">Kelola</a>
              </div>
          </div>
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.rashewan.index') }}" class="btn rounded-pill px-4"
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.pemilik.index') }}" class="btn btn-outline-success rounded-pill px-4">Kelola</a>
              </div>
          </div>
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.kategori.index') }}" class="btn btn-outline-warning rounded-pill px-4">Kelola</a>
              </div>
          </div>
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.kategoriKlinis.index') }}" class="btn rounded-pill px-4"
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.KodeTindakanTerapi.index') }}" class="btn btn-outline-danger rounded-pill px-4">Kelola</a>
              </div>
          </div>
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.roleuser.index') }}" class="btn btn-outline-warning rounded-pill px-4">Kelola</a>
              </div>
          </div>
          ...
          <div class="col-md-4 col-lg-3">
              <div class="card shadow-sm border-0 rounded-4 text-center py-4 h-100">
                  ...
                  <a href="{{ route('admin.pet.index') }}" class="btn btn-outline-warning rounded-pill px-4">Kelola</a>
              </div>
          </div>
